...
/**
 * Разделители между частями составного ника (например, "Frost_Wolf",
 * "Frost.Wolf"). Не заданы нормативно ни Task.md, ни базой — это
 * инженерный стилистический выбор реализации (аналогично старому
 * Streamlit-генератору), а не продуктовое решение о смысле параметров.
 * При необходимости можно пересмотреть отдельно.
 */
export const WORD_SEPARATORS: readonly string[] = ["", "_", "-"];
